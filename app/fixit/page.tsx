    ...
    <main className="min-h-screen bg-white">
      ...
      <nav className="bg-white shadow-sm fixed top-0 w-full z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold text-blue-600">KWAN-2</Link>
          <div className="hidden md:flex gap-8 text-gray-600">
            <Link href="#services" className="hover:text-blue-600 transition">Services</Link>
            <Link href="#how-it-works" className="hover:text-blue-600 transition">How It Works</Link>
            <Link href="#pricing" className="hover:text-blue-600 transition">Pricing</Link>
            <Link href="#request" className="hover:text-blue-600 transition">Request Repair</Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <a href="tel:+12092719068" className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-50 transition">
                Get a Quote
              </a>
            </div>
            <p className="mt-6 text-gray-500">📞 (209) 271-9068 — Available Mon–Sat</p>
            <p className="text-gray-500">✉️ kwan2station@gmail.com</p>
          </div>
      ...
      <section id="pricing" className="py-20 bg-gray-50 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-500 mt-8 text-sm max-w-2xl mx-auto">Prices are estimates. Final pricing depends on scope, materials, labor, and complexity. Customers receive pricing before work begins.</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600 px-6 text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <a href="mailto:kwan2station@gmail.com" className="border-2 border-white text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-700 transition">
              ✉️ Email Us
            </a>
          </div>
        </div>
